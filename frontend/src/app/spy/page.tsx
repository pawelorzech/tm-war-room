      ...
      <div className="max-w-4xl mx-auto px-4 py-6 space-y-6">
        <div>
          ...
          <p className="text-text-secondary text-sm mt-1">
            Look up battle stat estimates for any Torn player. Searches TornStats automatically.
          </p>
        </div>
        ...
        <div className="bg-bg-secondary border-l-4 border-torn-green rounded-r-lg p-4 space-y-2">
          ...
          <ul className="text-xs text-text-secondary space-y-1">
            <li><span className="text-torn-green font-medium">Auto:</span> Searching a player fetches estimates from TornStats in real-time and saves them.</li>
            ...
            <li><span className="text-torn-green font-medium">Manual:</span> Did a spy in Torn? Submit the exact stats below — these are marked as "exact" and take highest priority.</li>
          </ul>
        </div>
