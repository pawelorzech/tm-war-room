            ...
            {results.map(m => (
              ...
              >
                ...
                <div
                  ...
                  /* The backend's FTS snippet() emits \x01 and \x02 around matches.
                   * We HTML-escape the raw string first, then replace the control characters
                   * with <mark> tags, and finally sanitize with DOMPurify to prevent XSS. */
