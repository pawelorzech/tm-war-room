      ...
      <div className="space-y-3">
        ...
        <div className="flex gap-2">
          <input
            ...
            className="bg-bg-elevated border border-border rounded px-3 py-1.5 text-sm text-text-primary w-40"
            onKeyDown={(e) => {
              if (e.key === "Enter") {
          ...
          <button
            ...
            className="bg-torn-green/20 text-torn-green border border-torn-green/30 rounded px-4 py-1.5 text-sm font-medium hover:bg-torn-green/30 transition-colors"
          >
            Load Enemy
          </button>
        </div>
  ...
  return (
    <div>
      ...
      <div className="text-sm text-text-secondary mb-1">
        ...
        <span className="text-torn-green">{atk}</span> attackable,{" "}
        <span className="text-torn-yellow">{hosp}</span> hospital,{" "}
        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            {sorted.map((m) => {
              ...
              const hospTime =
                m.status.state === "Hospital" && m.status.until
              ...
              return (
                ...
                >
                  ...
                  <td className="py-1.5 px-2">{threatCell}</td>
                  <td className="py-1.5 px-2">
                    {m.status.state === "Hospital" ? (
                  ...
                  <td className="py-1.5 px-2 text-text-muted">{xr}</td>
                  <td className="py-1.5 px-2 text-text-muted">{aw}</td>
                  <td className="py-1.5 px-2">
                    <div className="flex gap-1">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-xs px-2 py-0.5 rounded bg-bg-elevated text-text-secondary border border-border hover:text-text-primary transition-colors"
                      >
                        Stats
                      </a>
                    </div>
