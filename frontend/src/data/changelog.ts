...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    ...
    changes: [
      { type: "feat", text: "On /bounties.php every bounty row now gets a TM Hub threat badge with score + source (spy / estimated / no data) and the row gets a subtle background tint: green for trivial/easy, amber for moderate, red for dangerous, deep red for lethal. The TM Hub threat scorer factors in your own stats when available, so you see relative difficulty — not just absolute totals. Saves you from spending 50 nerve learning the hard way that the 'easy' $1.2M bounty was actually a 50M whale" },
